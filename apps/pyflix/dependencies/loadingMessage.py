...
def exitingAnimation(speed):
       ...
       frame8 = f"""
           {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame9 = f"""           {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame10 = f"""         g {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame11 = f"""        ng {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame12 = f"""       ing {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame13 = f"""      ting {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame14 = f"""     iting {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame15 = f"""    xiting {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       frame16 = f"""   Exiting {Fore.YELLOW}Py{Fore.RESET}{Fore.BLUE}flix{Fore.RESET}"""
       

       animation = [frame1, frame2, frame3, frame4, frame5, frame6, frame7, frame8, frame9, frame10, frame11, frame12, frame13, frame14, frame15, frame16]
